...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/* @ngInject */
module.exports = function adminDashboardController( $scope,$timeout,$viewusers,loginservice, $translate,$location, $state) {
  var vm = this;
  var height=loginservice.getFiledsData('height');
  console.log(height)
  vm.labels = [];
  vm.sliderAge = {
    minValue:18,
...
module.exports.$inject = ["$scope", "$timeout", "$viewusers", "loginservice", "$translate", "$location", "$state"];

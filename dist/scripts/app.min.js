...
module.exports.$inject = ["$viewusers", "loginservice", "$admintaskservice", "toastr"];
...
module.exports.$inject = ["$uibModal", "$uibModalInstance", "user", "$location", "Upload", "$timeout", "ServiceUrls", "toastr"];

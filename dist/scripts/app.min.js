...
module.exports.$inject = ["$location", "searchService", "$scope", "useractions", "$timeout", "$rootScope", "loginservice", "matcheservice"];
...
module.exports.$inject = ["messagesservice", "$state", "matcheservice", "searchService", "$rootScope"];

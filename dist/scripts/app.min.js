...
module.exports.$inject = ["$scope", "socket", "$state", "$location", "$uibModal", "$rootScope", "useractions", "messagesservice", "loginservice", "toastr"];

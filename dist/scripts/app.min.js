...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/* @ngInject */
module.exports = function viewUserController() {
...
module.exports.$inject = ["$location", "$rootScope", "$state", "routerConfig", "$sessionStorage"];

...
module.exports.$inject = ["$state", "searchService", "$location", "useractions", "$scope", "$timeout", "$rootScope", "loginservice", "messagesservice"];    
...
module.exports.$inject = ["$rootScope", "loginservice", "$uibModal", "$uibModalInstance", "user", "$location", "Upload", "$timeout", "ServiceUrls", "toastr"];

...
var controller = this;
  ...
  module.exports.$inject = ["loginservice", "$uibModal", "$uibModalInstance", "$rootScope", "countryService"];
...
module.exports.$inject = ["loginservice", "messagesservice"];

...
module.exports = function (messagesservice,useractions,$rootScope) {
    ...
    module.exports.$inject = ["messagesservice", "useractions", "$rootScope"];
...
module.exports = function (loginservice,messagesservice,useractions, $rootScope) {
    ...
    module.exports.$inject = ["loginservice", "messagesservice", "useractions", "$rootScope"];
...
module.exports.$inject = ["searchService", "loginservice", "matcheservice", "useractions", "$rootScope"];
...
module.exports.$inject = ["$http", "$viewusers", "$state", "$sessionStorage", "$localStorage", "ServiceUrls", "$location", "$uibModal", "$rootScope"];

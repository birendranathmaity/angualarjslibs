...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
/* @ngInject */
module.exports = function adminDashboardController() {
...
module.exports.$inject = ["$rootScope", "$viewusers", "loginservice", "$admintaskservice", "toastr"];
...
module.exports.$inject = ["$translate", "$state"];
...
module.exports.$inject = ["$uibModal", "$filter", "countryService", "loginservice"];
...
module.exports.$inject = ["$uibModal", "loginservice"];
